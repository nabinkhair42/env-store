    ...
    <main className="mx-auto w-full max-w-4xl px-6 py-16">
      <div className="prose prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 leading-relaxed text-muted-foreground">
            We retain your personal information and environment variables for as
            long as your account is active or as needed to provide you services.
            You can delete your projects and associated environment variables at
            any time through the dashboard. Account deletion will permanently
