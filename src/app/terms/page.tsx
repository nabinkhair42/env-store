      ...
      <div className="prose prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed text-muted-foreground">
            By accessing or using ENV Store (&quot;Service&quot;), you agree to
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 leading-relaxed text-muted-foreground">
            ...
            and management of environment variables for developers. The Service
            allows you to:
          </p>
        ...
        <section className="mb-8">
          ...
          <h3 className="mb-3 text-xl font-semibold">Account Responsibility</h3>
          <p className="mb-4 leading-relaxed text-muted-foreground">
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed text-muted-foreground">
            You agree to indemnify and hold harmless ENV Store, its creator, and
            affiliates from any claims, damages, losses, or expenses (including
            legal fees) arising from your use of the Service, violation of these
